namespace Marqeta.Core.Abstractions
{
    ...
    public partial class UserClient : IUserClient
    {
        ...
        public System.Threading.Tasks.Task<Peer_transfer_response> RecipientAsync(string user_or_business_token, int? count, int? start_index, string fields)
        {
            return RecipientAsync(user_or_business_token, count, start_index, fields, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Peer_transfer_response> RecipientAsync(string user_or_business_token, int? count, int? start_index, string fields, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("User token not found", (int)response_.StatusCode, responseText_, headers_, null);
                        }
                        else
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Peer_transfer_response> SenderAsync(string user_or_business_token, int? count, int? start_index, string fields)
        {
            return SenderAsync(user_or_business_token, count, start_index, fields, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Peer_transfer_response> SenderAsync(string user_or_business_token, int? count, int? start_index, string fields, System.Threading.CancellationToken cancellationToken)
        {
            if (user_or_business_token == null)
                throw new System.ArgumentNullException("user_or_business_token");
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Velocity_control_balance_response> AvailableAsync(string user_token, int? count, int? start_index, string fields, string sort_by)
        {
            return AvailableAsync(user_token, count, start_index, fields, sort_by, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Velocity_control_balance_response> AvailableAsync(string user_token, int? count, int? start_index, string fields, string sort_by, System.Threading.CancellationToken cancellationToken)
        {
            if (user_token == null)
                throw new System.ArgumentNullException("user_token");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/velocitycontrols/user/{user_token}/available?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<Velocity_control_balance_response>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "400") 
                        ...
                        return default(Velocity_control_balance_response);
                    }
                    finally
                    {
                        if (response_ != null)
