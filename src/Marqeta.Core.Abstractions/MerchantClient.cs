namespace Marqeta.Core.Abstractions
{
    ...
    public partial class MerchantClient : IMerchantClient
    {
        ...
        public MerchantClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<Card_response> ShowpanAsync(string merchant_token, string fields, bool? show_cvv_number)
        {
            return ShowpanAsync(merchant_token, fields, show_cvv_number, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Card_response> ShowpanAsync(string merchant_token, string fields, bool? show_cvv_number, System.Threading.CancellationToken cancellationToken)
        {
            if (merchant_token == null)
                throw new System.ArgumentNullException("merchant_token");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/cards/merchant/{merchant_token}/showpan?");
