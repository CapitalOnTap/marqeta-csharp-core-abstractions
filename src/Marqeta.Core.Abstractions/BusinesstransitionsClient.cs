namespace Marqeta.Core.Abstractions
{
    ...
    public partial class BusinesstransitionsClient : IBusinesstransitionsClient
    {
        private string _baseUrl = "/v3";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public BusinesstransitionsClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<BusinessTransitionResponse>> BusinessAsync(string business_token, int? count, int? start_index, string fields, string sort_by)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<BusinessTransitionResponse>> BusinessAsync(string business_token, int? count, int? start_index, string fields, string sort_by, System.Threading.CancellationToken cancellationToken)
        {
            if (business_token == null)
                throw new System.ArgumentNullException("business_token");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/businesstransitions/business/{business_token}?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<BusinessTransitionResponse>>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(System.Collections.Generic.ICollection<BusinessTransitionResponse>);
                    }
                    finally
                    {
                        if (response_ != null)
