namespace Marqeta.Core.Abstractions
{
    ...
    public partial class UsertransitionsClient : IUsertransitionsClient
    {
        private string _baseUrl = "/v3";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public UsertransitionsClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <summary>Retrieve transitions for a given user</summary>
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<UserTransitionResponse>> UserAsync(string user_token, int? count, int? start_index, string fields, string sort_by)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<UserTransitionResponse>> UserAsync(string user_token, int? count, int? start_index, string fields, string sort_by, System.Threading.CancellationToken cancellationToken)
        {
            if (user_token == null)
                throw new System.ArgumentNullException("user_token");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/usertransitions/user/{user_token}?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<UserTransitionResponse>>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(System.Collections.Generic.ICollection<UserTransitionResponse>);
                    }
                    finally
                    {
                        if (response_ != null)
