...
namespace Marqeta.Core.Abstractions
{
    ...
    public class Digital_wallet_apple_pay_provision_request
    {
        ...
        [Required]
        public ICollection<string> Certificates { get; set; } = new Collection<string>();

        [JsonProperty("nonce", Required = Required.Always)]
        [Required(AllowEmptyStrings = true)]
        public string Nonce { get; set; }

        [JsonProperty("nonce_signature", Required = Required.Always)]
        [Required(AllowEmptyStrings = true)]
