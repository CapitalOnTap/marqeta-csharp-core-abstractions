...
namespace Marqeta.Core.Abstractions
{
    ...
    public class Accepted_countries_model
    {
        ...
        [JsonProperty("is_whitelist", Required = Required.Always)]
        public bool Is_whitelist { get; set; }

        [JsonProperty("country_codes", Required = Required.Always)]
        [Required]
        public ICollection<string> Country_codes { get; set; } = new Collection<string>();
