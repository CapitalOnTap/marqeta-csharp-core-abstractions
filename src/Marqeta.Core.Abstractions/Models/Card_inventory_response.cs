namespace Marqeta.Core.Abstractions
{
    ...
    public partial class Card_inventory_response 
    {
        ...
        [Newtonsoft.Json.JsonProperty("package_id", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string Package_id { get; set; }
    
        [Newtonsoft.Json.JsonProperty("starting_inventory", Required = Newtonsoft.Json.Required.Always)]
