...
namespace Marqeta.Core.Abstractions
{
    ...
    public class Offer_order_aggregated_balances
    {
        ...
        [Required]
        public IDictionary<string, Offer_order_aggregated_balances> Balances { get; set; } =
            new Dictionary<string, Offer_order_aggregated_balances>();
