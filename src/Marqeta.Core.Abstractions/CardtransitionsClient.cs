namespace Marqeta.Core.Abstractions
{
    ...
    public partial class CardtransitionsClient : ICardtransitionsClient
    {
        private string _baseUrl = "/v3";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public CardtransitionsClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <summary>List all card transitions</summary>
        /// <param name="token">Card Token</param>
        /// <param name="count">Number of card transition to retrieve</param>
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Card_transition_response>> CardAsync(string token, int? count, int? start_index, string fields, string sort_by)
        {
            return CardAsync(token, count, start_index, fields, sort_by, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Card_transition_response>> CardAsync(string token, int? count, int? start_index, string fields, string sort_by, System.Threading.CancellationToken cancellationToken)
        {
            if (token == null)
                throw new System.ArgumentNullException("token");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/cardtransitions/card/{token}?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<Card_transition_response>>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(System.Collections.Generic.ICollection<Card_transition_response>);
                    }
                    finally
                    {
                        if (response_ != null)
