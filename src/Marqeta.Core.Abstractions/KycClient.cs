namespace Marqeta.Core.Abstractions
{
    ...
    public partial class KycClient : IKycClient
    {
        ...
        /// <summary>Lists all KYC results for a business</summary>
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Kyc_response>> BusinessAsync(string business_token, int? count, int? start_index, string fields, string sort_by)
        {
            return BusinessAsync(business_token, count, start_index, fields, sort_by, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Kyc_response>> BusinessAsync(string business_token, int? count, int? start_index, string fields, string sort_by, System.Threading.CancellationToken cancellationToken)
        {
            if (business_token == null)
                throw new System.ArgumentNullException("business_token");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/kyc/business/{business_token}?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<Kyc_response>>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(System.Collections.Generic.ICollection<Kyc_response>);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <summary>Lists all KYC results for a user</summary>
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Kyc_response>> UserAsync(string user_token, int? count, int? start_index, string fields, string sort_by)
        {
            return UserAsync(user_token, count, start_index, fields, sort_by, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Kyc_response>> UserAsync(string user_token, int? count, int? start_index, string fields, string sort_by, System.Threading.CancellationToken cancellationToken)
        {
            if (user_token == null)
                throw new System.ArgumentNullException("user_token");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/kyc/user/{user_token}?");
