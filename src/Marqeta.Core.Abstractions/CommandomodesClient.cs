namespace Marqeta.Core.Abstractions
{
    ...
    public partial class CommandomodesClient : ICommandomodesClient
    {
        private string _baseUrl = "/v3";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public CommandomodesClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<Commando_mode_transition_response> TransitionsGetAsync(string token)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Commando_mode_transition_response> TransitionsGetAsync(string token, System.Threading.CancellationToken cancellationToken)
        {
            if (token == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<Commando_mode_transition_response>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(Commando_mode_transition_response);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Commando_mode_transition_response>> TransitionsGetAsync(int? count, int? start_index, string sort_by, string commandomode_token)
        {
            return TransitionsGetAsync(count, start_index, sort_by, commandomode_token, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Commando_mode_transition_response>> TransitionsGetAsync(int? count, int? start_index, string sort_by, string commandomode_token, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<Commando_mode_transition_response>>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "400") 
                        ...
                        return default(System.Collections.Generic.ICollection<Commando_mode_transition_response>);
                    }
                    finally
                    {
                        if (response_ != null)
