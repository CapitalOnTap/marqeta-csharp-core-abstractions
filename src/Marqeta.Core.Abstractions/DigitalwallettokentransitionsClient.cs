namespace Marqeta.Core.Abstractions
{
    ...
    public partial class DigitalwallettokentransitionsClient : IDigitalwallettokentransitionsClient
    {
        private string _baseUrl = "/v3";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public DigitalwallettokentransitionsClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Digital_wallet_token_transition_response>> DigitalwallettokenAsync(string token, int? count, int? start_index, string fields, string sort_by)
        {
            return DigitalwallettokenAsync(token, count, start_index, fields, sort_by, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Digital_wallet_token_transition_response>> DigitalwallettokenAsync(string token, int? count, int? start_index, string fields, string sort_by, System.Threading.CancellationToken cancellationToken)
        {
            if (token == null)
                throw new System.ArgumentNullException("token");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/digitalwallettokentransitions/digitalwallettoken/{token}?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<Digital_wallet_token_transition_response>>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(System.Collections.Generic.ICollection<Digital_wallet_token_transition_response>);
                    }
                    finally
                    {
                        if (response_ != null)
