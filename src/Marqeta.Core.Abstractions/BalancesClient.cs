namespace Marqeta.Core.Abstractions
{
    ...
    public partial class BalancesClient : IBalancesClient
    {
        private string _baseUrl = "/v3";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public BalancesClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<Cardholder_msa_balance> MsasAsync(string token, int? count, int? start_index, string sort_by)
        {
            return MsasAsync(token, count, start_index, sort_by, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Cardholder_msa_balance> MsasAsync(string token, int? count, int? start_index, string sort_by, System.Threading.CancellationToken cancellationToken)
        {
            if (token == null)
                throw new System.ArgumentNullException("token");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/balances/{token}/msas?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<Cardholder_msa_balance>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(Cardholder_msa_balance);
                    }
                    finally
                    {
                        if (response_ != null)
