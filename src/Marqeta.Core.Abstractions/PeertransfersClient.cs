namespace Marqeta.Core.Abstractions
{
    ...
    public partial class PeertransfersClient : IPeertransfersClient
    {
        private string _baseUrl = "/v3";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public PeertransfersClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<Peer_transfer_response> UserAsync(string user_or_business_token, int? count, int? start_index, string fields)
        {
            return UserAsync(user_or_business_token, count, start_index, fields, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Peer_transfer_response> UserAsync(string user_or_business_token, int? count, int? start_index, string fields, System.Threading.CancellationToken cancellationToken)
        {
