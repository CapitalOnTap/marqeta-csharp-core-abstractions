namespace Marqeta.Core.Abstractions
{
    ...
    public partial class WebhooksClient : IWebhooksClient
    {
        ...
        public System.Threading.Tasks.Task<Webhook_ping_model> PingAsync(string token)
        {
            return PingAsync(token, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Webhook_ping_model> PingAsync(string token, System.Threading.CancellationToken cancellationToken)
        {
            if (token == null)
                throw new System.ArgumentNullException("token");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/webhooks/{token}/ping");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<Webhook_ping_model>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(Webhook_ping_model);
                    }
                    finally
                    {
                        if (response_ != null)
