namespace Marqeta.Core.Abstractions
{
    ...
    public partial class MerchantsClient : IMerchantsClient
    {
        ...
        public MerchantsClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <summary>Lists stores associated with a specific merchant</summary>
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Store_response_model>> StoresAsync(string token, int? count, int? start_index, string fields, string sort_by)
        {
            return StoresAsync(token, count, start_index, fields, sort_by, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Store_response_model>> StoresAsync(string token, int? count, int? start_index, string fields, string sort_by, System.Threading.CancellationToken cancellationToken)
        {
            if (token == null)
                throw new System.ArgumentNullException("token");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/merchants/{token}/stores?");
