namespace Marqeta.Core.Abstractions
{
    ...
    public partial class ProgramClient : IProgramClient
    {
        ...
        public System.Threading.Tasks.Task<Base_ach_response_model> AchGetAsync(int? count, int? start_index, string fields, string sort_by)
        {
            return AchGetAsync(count, start_index, fields, sort_by, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Base_ach_response_model> AchGetAsync(int? count, int? start_index, string fields, string sort_by, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<Base_ach_response_model>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(Base_ach_response_model);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Base_ach_response_model> AchPostAsync(Base_ach_request_model body)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Base_ach_response_model> AchPostAsync(Base_ach_request_model body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/fundingsources/program/ach");
